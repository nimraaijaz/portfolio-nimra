...
import { Github, ExternalLink, Terminal, Globe } from "lucide-react";
...
* Safely cycle through the available project visuals.
* This prevents undefined visuals if PROJECTS contains more
* projects than PROJECT_VISUALS.
  */
  const Visual =
  PROJECT_VISUALS[index % PROJECT_VISUALS.length];
...
5: (
  <div className="relative flex h-20 w-20 items-center justify-center">
    ...
    >
      ...
      <path
        d="M35 4 V14 M35 56 V66 M4 35 H14 M56 35 H66"
        stroke={accent}
        strokeWidth="2"
        strokeLinecap="round"
      />
...
<div
ref={containerRef}
className={!isLast ? "h-[105vh]" : "h-auto"}
>
<motion.div
className={!isLast ? "sticky top-16" : ""}
style={{
scale,
y,
opacity,
...
>
{/* Section artifact backdrop */} <div
         aria-hidden
         className="pointer-events-none absolute -right-8 -top-8 opacity-15"
       >
{artifacts[index % Object.keys(artifacts).length]} </div>
        ...
        <div className="order-2 p-6 md:p-10 lg:order-1">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {project.live && (
                <a
                  ...
                  className="glow-border-hover shrink-0 inline-flex items-center gap-2 rounded-full border border-[rgba(45,212,191,0.4)] bg-[rgba(45,212,191,0.07)] px-5 py-2.5 font-mono text-[0.7rem] font-semibold uppercase tracking-[0.12em] text-[#5eead4] transition-colors duration-200 hover:bg-[rgba(45,212,191,0.15)]"
                >
                  <Globe size={15} />
              ...
              {project.github && (
                <a
                  ...
                  className="glow-border-hover shrink-0 inline-flex items-center gap-2 rounded-full border border-[rgba(56,189,248,0.35)] bg-[rgba(56,189,248,0.06)] px-5 py-2.5 font-mono text-[0.7rem] font-semibold uppercase tracking-[0.12em] text-[#7dd3fc] transition-colors duration-200 hover:bg-[rgba(56,189,248,0.14)]"
                >
                  <Github size={15} />
          ...
          {project.highlights && (
            <div className="mt-6 border-t border-[rgba(56,189,248,0.1)] pt-5">
              <p className="mb-3 font-mono text-[0.65rem] uppercase tracking-[0.2em] text-[#38bdf8]">
                Engineering Highlights
              </p>
              ...
              <div className="grid gap-1.5 sm:grid-cols-2">
                {project.highlights.map((h) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-[#c7ddf3]">
                      {h}
                    </span>
                  </div>
                ))}
          ...
          {/* Stack */}
          <div className="mt-6">
            <p className="mb-2.5 font-mono text-[0.65rem] uppercase tracking-[0.2em] text-[#8aa3bd]">
              Stack
            </p>
          ...
          {/* Badge */}
          {project.badge && (
            <span className="mt-5 inline-flex items-center gap-1.5 rounded-full border border-[rgba(45,212,191,0.5)] bg-[rgba(45,212,191,0.1)] px-3.5 py-1.5 font-mono text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[#5eead4] shadow-[0_0_18px_rgba(45,212,191,0.25)]">
...
return ( <section
 ...
 > <Floating
     ...
     aria-hidden
   > <CodeBrackets size={72} /> </Floating>

```
  <Floating
    speed={0.9}
    delay={1.2}
    className="right-[3%] top-40 hidden xl:block"
    aria-hidden
  >
    <DbCylinder size={60} />
  </Floating>
